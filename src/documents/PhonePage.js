...
import '../stylesheets/phonePage.css'
  ...
  return (
    ...
    <div className='handbagItemDetails-container'>
      ...
      <div className='handbagItemPriceDetail'>
        ...
        {eachMobile.discount && 
        <div className='handbagItem-cancelPrice'>{svgRupeeSmall}<p id='mobleItem-cancelprice'>{Number(eachMobile.realprice).toLocaleString('en-IN')}</p>
      ...
      {showADDnew && <div className='upd-del' style={{display:'flex',flexDirection:'column',gap:'10px',width:'90%'}}>
