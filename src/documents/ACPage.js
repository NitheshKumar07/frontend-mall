...
{ (filteredProducts.length > 0 ? filteredProducts : mobile).map((eachMobile,index)  => {
  return (
    <div className='chudidar-main-container ac-main-container' key={eachMobile._id}>
    <div className='mobileItemImg-container acItemImg-container'>
    ...
    <div className='handbagItemDetails-container'>
      ...
      <a className='chudidarItem-name acItem-name' id='handbagItem-name-ID' onClick={()=>navigateSoloLaptop(eachMobile._id)}>{eachMobile.title}</a>
