...
const SoloGame = () => {
 ...
 useEffect(() => {
  ...
  <div className='soloShoeImg-Container'>
      <div className='soloShoeImg-box soloGameImg-box'>
        ...
        <div className='homeShoe-subcontainer'>
            {mobile.map((eachmobile) => {
              return(
                ...
                <img src={eachmobile.photo} alt={eachmobile.title} style={{objectFit:'contain', width:'80%',height:'80%'}}/>
                </div>
