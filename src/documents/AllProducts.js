...
const AllProducts = () => {
  ...
  useEffect(() => {
    setLoading(true);   
    axios.get(`${process.env.REACT_APP_API_URL}/66e0ac832e6bda2ea8fee821`)
      .then(res => {
        setLoading(false);
  ...
  useEffect(() => {
    setLoading(true);   
    axios.get(`${process.env.REACT_APP_API_URL}/66e0acbc2e6bda2ea8fee823`)
      .then(res => {
        setLoading(false);
    ...
    useEffect(() => {
      setLoading(true);   
      axios.get(`${process.env.REACT_APP_API_URL}/66e0ac4a2e6bda2ea8fee81f`)
        .then(res => {
          setLoading(false);
  ...
  useEffect(() => {
    setLoading(true);   
    axios.get(`${process.env.REACT_APP_API_URL}/66b7094e89c2a12074133b29`)
      .then(res => {
        setLoading(false);
        ...
        <div className='menuBar' >
          <div className='cancel-content'>
            <div id='sidebar-profileContainer'>
              ...
              <h1 id='hello'>hello {token &&  <span>{user}</span>}</h1></div>
